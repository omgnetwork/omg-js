...
export default {
  ...
  erc20_contract_address: process.env.ERC20_CONTRACT_ADDRESS ? OmgJS.util.prefixHex(process.env.ERC20_CONTRACT_ADDRESS) : undefined,
  ...
  blocks_to_wait_for_txn: Number(process.env.BLOCKS_TO_WAIT_FOR_TXN) || 20
}
